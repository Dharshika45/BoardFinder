    ...
    <div class="ts-main-content">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title">View Owners</h2>
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            ...
                                            { ?>
                                                <tr style="background-color: rgba(113, 99, 186, 0.1);">
                                                    ...
                                                    <td>
                                                        <a href="edit-owner.php?id=<?php echo htmlentities($result->id); ?>"><i class="fa fa-edit" style="color:green;"></i></a>&nbsp;&nbsp;
                                                        <a href="view-owners.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete?');"><i class="fa fa-close" style="color:red;"></i></a>
                                                    </td>
                                                </tr>
                                            <?php $cnt++; }
                                        } ?>
